...
//    MODEL_TCN_FLOAT32
//
//  Modelo gerado pelo pipeline atual:
//    MODEL_PIPELINE_TINY_CNN_INT8
// ============================================================
...
// Modelo ativo por padrao: ultimo candidato aprovado/exportado pelo pipeline.
...
#if ACTIVE_MODEL == MODEL_PIPELINE_TINY_CNN_INT8
...
#else
  #error "ACTIVE_MODEL invalido. Use MODEL_PIPELINE_TINY_CNN_INT8, MODEL_TCN_INT8, MODEL_TCN_FLOAT16 ou MODEL_TCN_FLOAT32."
#endif
