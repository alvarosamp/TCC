...
\begin{table}[htbp]
  ...
  \begin{tabular}{lc}
    ...
    \texttt{tiny\_tcn\_int8.h} (C array) & 115~KB \\
    \bottomrule
  \end{tabular}
\end{table}
...
Estimated inference RAM (arena) is $\leq$80~KB, compatible with the
512~KB SRAM available on the ESP32.
On-device latency measurement is scheduled as future work.
